    ...
    record Movement(Mapping mapping) implements ScratchFeature {
        ...
        public void accept(ClientPacket packet) {
            ...
            if (packet instanceof ClientPlayerPositionAndRotationPacket positionAndRotationPacket) {
                ...
                mapping.signalMovement(new EntityTeleportPacket(id, position, Vec.ZERO, RelativeFlags.DELTA_COORD, positionAndRotationPacket.onGround()));
                ...
                mapping.updatePosition(position);
                mapping.signalMovement(new EntityTeleportPacket(id, position, Vec.ZERO, RelativeFlags.DELTA_COORD, positionPacket.onGround()));
        ...
        public void accept(ClientPacket packet) {
            if (packet instanceof ClientClickWindowPacket(
                ...
                for (ClientClickWindowPacket.ChangedSlot changedSlot : changedSlots) {
                    final int internalSlot = PlayerInventoryUtils.convertPlayerInventorySlotToMinestomSlot(changedSlot.slot());
